...
import { getDataForMonth, saveMilkData,getDateData, getDateList, deleteEntry, getMonthEntries, depositAmount, getRemainingAmount } from "../app/controllers/app/milkDataController";
